...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        "group/tabs gap-2 flex data-horizontal:flex-col",
        className
      )}
      {...props}
    />
