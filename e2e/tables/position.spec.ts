...
function getCreateBtn(page: Page) {
  return page.getByTestId("create-position-btn")
}
...
test.describe("Positions page - guest", () => {
...
test.describe("Positions page - employee", () => {
  ...
  test("Table is visible and contains at least one row", async ({ page }) => {
    ...
    expect(rowCount, "Expected at least one position row").toBeGreaterThan(0)
  })
...
test.describe("Positions page - admin", () => {
